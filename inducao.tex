...
Principio da Indução finita \index{Indução finita} é formalmente definido como:\\
...
também pode ocorrer de existir uma propriedade que só comece a ser válida depois de algum valor específico, sendo assim definimos o principio da indução finita generalizada \index{Indução finita generalizada} como:\\
